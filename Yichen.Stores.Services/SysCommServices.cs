...
{
    public partial class SysCommServices : BaseServices<object>, ISysCommServices
    {
        ...
        public SysCommServices(IUnitOfWork unitOfWork
        ...
        /// <param name="infos"></param>
        /// <returns></returns>
        public async Task<WebApiCallBack> SysSaveDT(SaveTableInfo saveTable)
        {
            WebApiCallBack jm = new WebApiCallBack();
            try
            {
                //SaveTableInfo saveTable = JsonHandle.JsonConvertObject<SaveTableInfo>(info);
                ...
                if (b != 0)
                {
                    ...
                    //await StartupHelper.refreshbaseinfo(saveTable.TableName);
                    jm.code = 0;
                    jm.data = b;
        ...
        ///// <param name="infos"></param>
        ///// <returns></returns>
        //public async Task<string> SysUpdate(uInfo infos)
        //{
        ...
        //    {
        //        uInfo updateInfo = JsonHandle.JsonConvertObject<uInfo>(infos);
        //        string sql = SqlFormartHelper.updateFormart(updateInfo);
        //        int info = await _commRepository.sqlcommand(sql);
        ...
        ///// <param name="infos"></param>
        ///// <returns></returns>
        //public async Task<string> SysSelect(sInfo infos)
        //{
        ...
        //    {
        //        sInfo selectInfo = JsonHandle.JsonConvertObject<sInfo>(infos);
        //        string sql = SqlFormartHelper.selectFormart(selectInfo);
        //        DataTable dt = await _commRepository.GetTable(sql);
        //        return ConvertDatatable.DataTableToString(dt);
        //    }
        //    catch (Exception ex)
        //    {
        //        a = 0;
        ...
        ///// <param name="infos"></param>
        ///// <returns></returns>
        //public async Task<string> SysInsert(iInfo infos)
        //{
        //    WebApiCallBack jm = new WebApiCallBack();
        //    int a = 1;
        //    try
        //    {
        //        iInfo updateInfo = JsonHandle.JsonConvertObject<iInfo>(infos);
        //        string sql = SqlFormartHelper.insertFormart(updateInfo);
        //        int info = await _commRepository.sqlcommand(sql);
        ...
        ///// <param name="infos"></param>
        ///// <returns></returns>
        //public async Task<string> SysDelete(dInfo infos)
        //{
        //    WebApiCallBack jm = new WebApiCallBack();
        //    int a = 1;
        //    try
        //    {
        //        dInfo updateInfo = JsonHandle.JsonConvertObject<dInfo>(infos);
        //        string sql = SqlFormartHelper.deleteFormart(updateInfo);
        //        int info = await _commRepository.sqlcommand(sql);
        ...
        ///// <param name="infos"></param>
        ///// <returns></returns>
        //public async Task<string> SysHide(hideInfo infos)
        //{
        //    WebApiCallBack jm = new WebApiCallBack();
        //    int a = 1;
        //    try
        //    {
        //        hideInfo updateInfo = JsonHandle.JsonConvertObject<hideInfo>(infos);
        //        string sql = SqlFormartHelper.hideFormart(updateInfo);
        //        int info = await _commRepository.sqlcommand(sql);
        ...
        ///// <param name="infos"></param>
        ///// <returns></returns>
        //public async Task<bool> SysSaveDT(SaveTableInfo info)
        //{
