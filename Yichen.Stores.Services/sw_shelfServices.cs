...
namespace Yichen.Stores.Services
{
    ...
    /// 标本架信息 接口实现
    /// </summary>
    public class sw_shelfServices : BaseServices<sw_shelf>, Isw_shelfServices
    {
        private readonly Isw_shelfRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public sw_shelfServices(IUnitOfWork unitOfWork, Isw_shelfRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
