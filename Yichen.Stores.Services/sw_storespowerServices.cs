...
namespace Yichen.Stores.Services
{
    ...
    /// 存储库权限列表 接口实现
    /// </summary>
    public class sw_storespowerServices : BaseServices<sw_storespower>, Isw_storespowerServices
    {
        private readonly Isw_storespowerRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public sw_storespowerServices(IUnitOfWork unitOfWork, Isw_storespowerRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
