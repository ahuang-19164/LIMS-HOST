...
namespace Yichen.Finance.IRepository
{
    ...
    ///  工厂接口
    /// </summary>
    public interface IGroupChargeInfoRepository : IBaseRepository<finance_group_charge>
    {
        #region 重写增删改查操作===========================================================
        ...
        /// <returns></returns>
        Task<WebApiCallBack> InsertAsync(finance_group_charge entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<WebApiCallBack> UpdateAsync(finance_group_charge entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<WebApiCallBack> UpdateAsync(List<finance_group_charge> entity);
