...
namespace Yichen.Stores.IServices
{
    ...
    ///  服务工厂接口
    /// </summary>
    public interface Isw_storesServices : IBaseServices<sw_stores>
    {
        /// <summary>
        /// 获取标本架流水号
        /// </summary>
        /// <returns></returns>
        Task<WebApiCallBack> GetShelfSerial();

        /// <summary>
        /// 记录处理接口
        /// </summary>
        /// <returns></returns>
        Task<WebApiCallBack> RecordHandle(commInfoModel<string> commInfo);
