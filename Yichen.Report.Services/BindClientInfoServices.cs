...
namespace Yichen.Report.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class BindClientInfoServices : BaseServices<BindClientInfo>, IBindClientInfoServices
    {
        private readonly IBindClientInfoRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public BindClientInfoServices(IUnitOfWork unitOfWork, IBindClientInfoRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
