...
namespace Yichen.Report.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class SampleReportLogServices : BaseServices<SampleReportLog>, ISampleReportLogServices
    {
        private readonly ISampleReportLogRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public SampleReportLogServices(IUnitOfWork unitOfWork, ISampleReportLogRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
