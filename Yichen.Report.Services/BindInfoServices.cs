...
namespace Yichen.Report.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class BindInfoServices : BaseServices<BindInfo>, IBindInfoServices
    {
        private readonly IBindInfoRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public BindInfoServices(IUnitOfWork unitOfWork, IBindInfoRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
