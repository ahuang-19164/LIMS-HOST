...
namespace Yichen.Net.Repository
{
    ...
    public class CoreCmsAgentOrderRepository : BaseRepository<CoreCmsAgentOrder>, ICoreCmsAgentOrderRepository
    {
        ...
        /// <returns></returns>
        public  async Task<AdminUiCallBack> InsertAsync(CoreCmsAgentOrder entity)
        {
        ...
        /// <returns></returns>
        public  async Task<AdminUiCallBack> UpdateAsync(CoreCmsAgentOrder entity)
        {
            var jm = new AdminUiCallBack();
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public  async Task<AdminUiCallBack> UpdateAsync(List<CoreCmsAgentOrder> entity)
        {
            var jm = new AdminUiCallBack();
