...
namespace Yichen.Net.Web.Admin.Controllers
{
    ...
    public class {{ModelClassName}}Controller : ControllerBase
    {
        ...
        [HttpPost]
        [Description("创建提交")]
        public async Task<WebApiCallBack> DoCreate([FromBody]{{ModelClassName}} entity)
        {
        ...
        [HttpPost]
        [Description("编辑提交")]
        public async Task<WebApiCallBack> DoEdit([FromBody]{{ModelClassName}} entity)
        {
...
{% endfor %}
        ...
        public async Task<WebApiCallBack> DoSet{{field.DbColumnName}}([FromBody]FMUpdateBoolDataByIntId entity)
        {
            var jm = new WebApiCallBack();
