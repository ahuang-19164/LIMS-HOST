...
namespace Yichen.Net.IRepository
{
    ...
    public interface I{{ModelClassName}}Repository : IBaseRepository<{{ModelClassName}}>
    {
        ...
        /// <returns></returns>
        Task<WebApiCallBack> InsertAsync({{ModelClassName}} entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<WebApiCallBack> UpdateAsync({{ModelClassName}} entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<WebApiCallBack> UpdateAsync(List<{{ModelClassName}}> entity);
        ...
        /// <returns></returns>
        Task<IPageList<{{ModelClassName}}>> QueryPageAsync(
