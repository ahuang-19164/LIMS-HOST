...
namespace Yichen.Per.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class SampleInfoOtherServices : BaseServices<SampleInfoOther>, ISampleInfoOtherServices
    {
        private readonly ISampleInfoOtherRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public SampleInfoOtherServices(IUnitOfWork unitOfWork, ISampleInfoOtherRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
