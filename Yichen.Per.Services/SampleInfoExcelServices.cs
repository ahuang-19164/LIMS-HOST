...
namespace Yichen.Per.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class SampleInfoExcelServices : BaseServices<SampleInfoExcel>, ISampleInfoExcelServices
    {
        private readonly ISampleInfoExcelRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public SampleInfoExcelServices(IUnitOfWork unitOfWork, ISampleInfoExcelRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
