...
namespace Yichen.Per.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class SampleInfoJKServices : BaseServices<per_sampleInfojk>, ISampleInfoJKServices
    {
        private readonly ISampleInfoJKRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public SampleInfoJKServices(IUnitOfWork unitOfWork, ISampleInfoJKRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
