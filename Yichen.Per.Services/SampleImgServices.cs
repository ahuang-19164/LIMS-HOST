...
namespace Yichen.Per.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class SampleImgServices : BaseServices<SampleImg>, ISampleImgServices
    {
        private readonly ISampleImgRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public SampleImgServices(IUnitOfWork unitOfWork, ISampleImgRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
