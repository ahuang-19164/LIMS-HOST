...
namespace Yichen.Per.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class SampleBlendInfoServices : BaseServices<per_sampleblend>, ISampleBlendInfoServices
    {
        private readonly ISampleBlendInfoRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public SampleBlendInfoServices(IUnitOfWork unitOfWork, ISampleBlendInfoRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
