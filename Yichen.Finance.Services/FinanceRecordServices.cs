...
namespace Yichen.Finance.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class FinanceRecordServices : BaseServices<finance_record>, IFinanceRecordServices
    {
        private readonly IFinanceRecordRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public FinanceRecordServices(IUnitOfWork unitOfWork, IFinanceRecordRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
        ...
        /// <param name="entity">实体数据</param>
        /// <returns></returns>
        public  async Task<WebApiCallBack> InsertAsync(finance_record entity)
        {
        ...
        /// <returns></returns>
        public  async Task<WebApiCallBack> UpdateAsync(finance_record entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public  async Task<WebApiCallBack> UpdateAsync(List<finance_record> entity)
        {
            return await _dal.UpdateAsync(entity);
        }
        ...
        ///// </summary>
        ///// <returns></returns>
        //public async Task<List<Record>> GetCaChe()
        //{
        ...
        /////     更新cache
        ///// </summary>
        //public async Task<List<Record>> UpdateCaChe()
        //{
       ...
       #region 重写根据条件查询分页数据
        ...
        /// <returns></returns>
        public  async Task<IPageList<finance_record>> QueryPageAsync(Expression<Func<finance_record, bool>> predicate,
