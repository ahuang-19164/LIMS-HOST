...
namespace Yichen.Finance.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class FundInfoServices : BaseServices<FundInfo>, IFundInfoServices
    {
        private readonly IFundInfoRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public FundInfoServices(IUnitOfWork unitOfWork, IFundInfoRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
        ...
        /// <param name="entity">实体数据</param>
        /// <returns></returns>
        public  async Task<WebApiCallBack> InsertAsync(FundInfo entity)
        {
        ...
        /// <returns></returns>
        public  async Task<WebApiCallBack> UpdateAsync(FundInfo entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public  async Task<WebApiCallBack> UpdateAsync(List<FundInfo> entity)
        {
            return await _dal.UpdateAsync(entity);
        }
        ...
        ///// </summary>
        ///// <returns></returns>
        //public async Task<List<FundInfo>> GetCaChe()
        //{
        ...
        /////     更新cache
        ///// </summary>
        //public async Task<List<FundInfo>> UpdateCaChe()
        //{
       ...
       #region 重写根据条件查询分页数据
        ...
        /// <returns></returns>
        public  async Task<IPageList<FundInfo>> QueryPageAsync(Expression<Func<FundInfo, bool>> predicate,
