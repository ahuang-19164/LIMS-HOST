...
namespace Yichen.QC.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class HandleRecordServices : BaseServices<HandleRecord>, IHandleRecordServices
    {
        private readonly IHandleRecordRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public HandleRecordServices(IUnitOfWork unitOfWork, IHandleRecordRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
