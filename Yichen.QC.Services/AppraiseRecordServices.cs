...
namespace Yichen.QC.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class AppraiseRecordServices : BaseServices<AppraiseRecord>, IAppraiseRecordServices
    {
        private readonly IAppraiseRecordRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public AppraiseRecordServices(IUnitOfWork unitOfWork, IAppraiseRecordRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
