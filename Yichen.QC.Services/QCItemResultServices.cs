...
namespace Yichen.QC.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class QCItemResultServices : BaseServices<QCItemResult>, IQCItemResultServices
    {
        private readonly IQCItemResultRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public QCItemResultServices(IUnitOfWork unitOfWork, IQCItemResultRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
