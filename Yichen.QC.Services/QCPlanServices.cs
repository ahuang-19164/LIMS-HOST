...
namespace Yichen.QC.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class QCPlanServices : BaseServices<QCPlan>, IQCPlanServices
    {
        private readonly IQCPlanRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public QCPlanServices(IUnitOfWork unitOfWork, IQCPlanRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
