...
namespace Yichen.QC.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class QCPlanGradeServices : BaseServices<QCPlanGrade>, IQCPlanGradeServices
    {
        private readonly IQCPlanGradeRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public QCPlanGradeServices(IUnitOfWork unitOfWork, IQCPlanGradeRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
