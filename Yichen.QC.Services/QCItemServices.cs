...
namespace Yichen.QC.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class QCItemServices : BaseServices<QCItem>, IQCItemServices
    {
        private readonly IQCItemRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public QCItemServices(IUnitOfWork unitOfWork, IQCItemRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
