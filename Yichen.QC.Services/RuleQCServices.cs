...
namespace Yichen.QC.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class RuleQCServices : BaseServices<RuleQC>, IRuleQCServices
    {
        private readonly IRuleQCRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public RuleQCServices(IUnitOfWork unitOfWork, IRuleQCRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
