...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class RoleInfoWebServices : BaseServices<RoleInfoWeb>, IRoleInfoWebServices
    {
        private readonly IRoleInfoWebRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public RoleInfoWebServices(IUnitOfWork unitOfWork, IRoleInfoWebRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
