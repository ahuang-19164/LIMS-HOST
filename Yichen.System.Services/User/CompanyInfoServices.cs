...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class CompanyInfoServices : BaseServices<CompanyInfo>, ICompanyInfoServices
    {
        private readonly ICompanyInfoRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public CompanyInfoServices(IUnitOfWork unitOfWork, ICompanyInfoRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
