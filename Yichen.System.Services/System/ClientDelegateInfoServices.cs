...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class ClientDelegateInfoServices : BaseServices<ClientDelegateInfo>, IClientDelegateInfoServices
    {
        private readonly IClientDelegateInfoRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public ClientDelegateInfoServices(IUnitOfWork unitOfWork, IClientDelegateInfoRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
