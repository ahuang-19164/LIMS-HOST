...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class GroupGridServices : BaseServices<GroupGrid>, IGroupGridServices
    {
        private readonly IGroupGridRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public GroupGridServices(IUnitOfWork unitOfWork, IGroupGridRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
