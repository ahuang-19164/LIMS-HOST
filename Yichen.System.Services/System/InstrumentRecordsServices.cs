...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class InstrumentRecordsServices : BaseServices<InstrumentRecords>, IInstrumentRecordsServices
    {
        private readonly IInstrumentRecordsRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public InstrumentRecordsServices(IUnitOfWork unitOfWork, IInstrumentRecordsRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
