...
namespace Yichen.System.Services
{
    ...
    /// 选择题表 接口实现
    /// </summary>
    public class ClientGroupServices : BaseServices<comm_client_group>, IClientGroupServices
    {
        private readonly IClientGroupRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public ClientGroupServices(IUnitOfWork unitOfWork, IClientGroupRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
