...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class GroupWorkServices : BaseServices<GroupWork>, IGroupWorkServices
    {
        private readonly IGroupWorkRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public GroupWorkServices(IUnitOfWork unitOfWork, IGroupWorkRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
