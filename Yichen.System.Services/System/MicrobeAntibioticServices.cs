...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class MicrobeAntibioticServices : BaseServices<MicrobeAntibiotic>, IMicrobeAntibioticServices
    {
        private readonly IMicrobeAntibioticRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public MicrobeAntibioticServices(IUnitOfWork unitOfWork, IMicrobeAntibioticRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
