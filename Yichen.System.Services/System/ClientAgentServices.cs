...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class ClientAgentServices : BaseServices<ClientAgent>, IClientAgentServices
    {
        private readonly IClientAgentRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public ClientAgentServices(IUnitOfWork unitOfWork, IClientAgentRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
