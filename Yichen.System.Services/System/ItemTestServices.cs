...
namespace Yichen.System.Services
{
    ...
    /// 选择题表 接口实现
    /// </summary>
    public class ItemTestServices : BaseServices<comm_item_test>, IItemTestServices
    {
        private readonly IItemTestRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public ItemTestServices(IUnitOfWork unitOfWork, IItemTestRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
