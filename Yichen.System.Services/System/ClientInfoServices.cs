...
namespace Yichen.System.Services
{
    ...
    /// 选择题表 接口实现
    /// </summary>
    public class ClientInfoServices : BaseServices<comm_client_info>, IClientInfoServices
    {
        private readonly IClientInfoRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public ClientInfoServices(IUnitOfWork unitOfWork, IClientInfoRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
