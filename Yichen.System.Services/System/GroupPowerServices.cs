...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class GroupPowerServices : BaseServices<GroupPower>, IGroupPowerServices
    {
        private readonly IGroupPowerRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public GroupPowerServices(IUnitOfWork unitOfWork, IGroupPowerRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
