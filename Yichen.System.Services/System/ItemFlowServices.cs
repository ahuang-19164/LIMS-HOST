...
namespace Yichen.System.Services
{
    ...
    /// 选择题表 接口实现
    /// </summary>
    public class ItemFlowServices : BaseServices<comm_item_flow>, IItemFlowServices
    {
        private readonly IItemFlowRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public ItemFlowServices(IUnitOfWork unitOfWork, IItemFlowRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
