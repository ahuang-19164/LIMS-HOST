...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class ControlEditServices : BaseServices<ControlEdit>, IControlEditServices
    {
        private readonly IControlEditRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public ControlEditServices(IUnitOfWork unitOfWork, IControlEditRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
