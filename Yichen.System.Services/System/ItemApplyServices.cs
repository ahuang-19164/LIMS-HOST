...
namespace Yichen.System.Services
{
    ...
    /// 选择题表 接口实现
    /// </summary>
    public class ItemApplyServices : BaseServices<comm_item_apply>, IItemApplyServices
    {
        private readonly IItemApplyRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public ItemApplyServices(IUnitOfWork unitOfWork, IItemApplyRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
