...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class InstrumentInfoServices : BaseServices<InstrumentInfo>, IInstrumentInfoServices
    {
        private readonly IInstrumentInfoRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public InstrumentInfoServices(IUnitOfWork unitOfWork, IInstrumentInfoRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
