...
namespace Yichen.System.Services
{
    ...
    /// 选择题表 接口实现
    /// </summary>
    public class ItemGroupServices : BaseServices<comm_item_group>, IItemGroupServices
    {
        private readonly IItemGroupRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public ItemGroupServices(IUnitOfWork unitOfWork, IItemGroupRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
