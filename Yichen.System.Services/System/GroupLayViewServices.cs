...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class GroupLayViewServices : BaseServices<GroupLayView>, IGroupLayViewServices
    {
        private readonly IGroupLayViewRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public GroupLayViewServices(IUnitOfWork unitOfWork, IGroupLayViewRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
