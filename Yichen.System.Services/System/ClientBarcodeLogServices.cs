...
namespace Yichen.System.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class ClientBarcodeLogServices : BaseServices<ClientBarcodeLog>, IClientBarcodeLogServices
    {
        private readonly IClientBarcodeLogRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public ClientBarcodeLogServices(IUnitOfWork unitOfWork, IClientBarcodeLogRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
