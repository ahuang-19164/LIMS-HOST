...
{
    public class MemoryCacheManager<T> : IManualCacheManager<T>
    {
        ...
        public List<T> LIMSGetKeyValue(CachInfos<T> keyinfo)
        {
            ...
            CachInfos<T> cachInfo = new CachInfos<T>();
            cachInfo.key = keyinfo.key;
            cachInfo.tablename = keyinfo.tablename;
            cachInfo.disname = grouptestkey;
            cachInfo.data = group_test;
            keyinfo = cachInfo;
            return group_test;
