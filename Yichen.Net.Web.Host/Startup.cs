...
using System;
using System.Linq;
using Yichen.Net.Auth;
using Yichen.Net.Configuration;
using Yichen.Net.Core.AutoFac;
using Yichen.Net.Core.Config;
using Yichen.Net.Filter;
using Yichen.Net.Loging;
using Yichen.Net.Mapping;
using Yichen.Net.Middlewares;
using Yichen.Net.Swagger;
using Yichen.Net.WeChat.Service.Mediator;
using Yichen.Net.Tasks;
...
namespace Yichen.Net.Web.Host
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //注册自定义微信接口配置文件
            services.Configure<Yichen.Net.WeChat.Service.Options.WeChatOptions>(Configuration.GetSection(nameof(Yichen.Net.WeChat.Service.Options.WeChatOptions)));

            // 注入工厂 HTTP 客户端
            services.AddHttpClient();
            services.AddSingleton<Yichen.Net.WeChat.Service.HttpClients.IWeChatApiHttpClientFactory, Yichen.Net.WeChat.Service.HttpClients.WeChatApiHttpClientFactory>();
            ...
            Console.WriteLine("Yichen.Net.Web.Host 服务正在启动！");
        }
