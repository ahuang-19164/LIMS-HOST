...
namespace Yichen.Comm.Services
{
 ...
 // 在退出构造函数时，不可为 null 的 字段“BaseDal”必须包含非 null 值。请考虑将 字段 声明为可以为 null。
 ...
 // 在退出构造函数时，不可为 null 的 字段“BaseDal”必须包含非 null 值。请考虑将 字段 声明为可以为 null。
        ...
        {
            return BaseDal.Insert(strSql, parameters);
        }
        ...
        {
            return await BaseDal.InsertAsync(strSql, parameters);
        }
        /// <summary>
        ///     写入实体数据
        /// </summary>
        ...
        {
            return await BaseDal.HideAsync(id);
        }
        /// <summary>
        ///     删除数据
        /// </summary>
        ...
        ///// <param name="sql"></param>
        ///// <returns></returns>
        //public async Task<DataTable> SqlQueryableDT(string sql)
        //{
        //    return await BaseDal.SqlQueryableDT(sql);
        //}
    }
}