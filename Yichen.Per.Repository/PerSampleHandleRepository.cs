...
namespace Yichen.Per.Repository
{
    ...
    ///  接口实现
    /// </summary>
    public class PerSampleHandleRepository : BaseRepository<per_sampleInfo>, IPerSampleInfoRepository
    {
        private readonly IUnitOfWork _unitOfWork;
        public PerSampleHandleRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
