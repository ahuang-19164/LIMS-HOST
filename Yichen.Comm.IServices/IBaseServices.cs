...
namespace Yichen.Comm.IServices
{
    /// <summary>
    ///     服务仓储通用接口类
    /// </summary>
    ...
    public interface IBaseServices<T> where T : class
    {
        ...
        Task<bool> InsertAsync(string strSql, SugarParameter[] parameters = null);
        ...
        ///// <param name="sql"></param>
        ///// <returns></returns>
        //Task<DataTable> SqlQueryableDT(string sql);
    }
}