...
namespace Yichen.Net.Services
{
    ...
    public class CoreCmsFormSubmitServices : BaseServices<CoreCmsFormSubmit>, ICoreCmsFormSubmitServices
    {
        ...
        /// <param name="entity">实体数据</param>
        /// <returns></returns>
        public  async Task<AdminUiCallBack> InsertAsync(CoreCmsFormSubmit entity)
        {
        ...
        /// <returns></returns>
        public  async Task<AdminUiCallBack> UpdateAsync(CoreCmsFormSubmit entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public  async Task<AdminUiCallBack> UpdateAsync(List<CoreCmsFormSubmit> entity)
        {
            return await _dal.UpdateAsync(entity);
        }
