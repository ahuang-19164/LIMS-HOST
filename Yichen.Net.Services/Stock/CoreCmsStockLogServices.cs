...
namespace Yichen.Net.Services
{
    ...
    public class CoreCmsStockLogServices : BaseServices<CoreCmsStockLog>, ICoreCmsStockLogServices
    {
        ...
        /// <returns></returns>
        public  async Task<AdminUiCallBack> InsertAsync(CoreCmsStockLog entity)
        {
        ...
        /// <returns></returns>
        public  async Task<AdminUiCallBack> UpdateAsync(CoreCmsStockLog entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public  async Task<AdminUiCallBack> UpdateAsync(List<CoreCmsStockLog> entity)
        {
            return await _dal.UpdateAsync(entity);
        }
