    ...
    public class CodeGeneratorController : ControllerBase
    {
        ...
        public AdminUiCallBack GetTables()
        {
            ...
            var jm = new AdminUiCallBack
            {
                code = 0,
                data = _mapper
                    .Map<List<SqlSugar.DbTableInfo>, List<Yichen.Net.Model.ViewModels.Basics.DbTableInfoTree>>(tables)
            };
            return jm;
        }
        ...
        [HttpPost]
        [Description("生成代码")]
        public ActionResult CodeGenDown(string tableName,string fileType)
        {
            var jm = new AdminUiCallBack();
            ...
            if (tableName == "AllTable")
            {
                ...
                if (data != null)
                {
                    return File(data, Application.Zip, tableName + "-" + fileType + ".zip");
                }
                else
                {
