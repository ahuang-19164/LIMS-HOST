...
namespace Yichen.Net.IServices
{
    ...
    public interface ICoreCmsDistributionOrderServices : IBaseServices<CoreCmsDistributionOrder>
    {
        ...
        /// <returns></returns>
        Task<AdminUiCallBack> InsertAsync(CoreCmsDistributionOrder entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<AdminUiCallBack> UpdateAsync(CoreCmsDistributionOrder entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<AdminUiCallBack> UpdateAsync(List<CoreCmsDistributionOrder> entity);
