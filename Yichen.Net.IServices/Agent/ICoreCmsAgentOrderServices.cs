...
namespace Yichen.Net.IServices
{
    ...
    public interface ICoreCmsAgentOrderServices : IBaseServices<CoreCmsAgentOrder>
    {
        ...
        /// <returns></returns>
        Task<AdminUiCallBack> InsertAsync(CoreCmsAgentOrder entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<AdminUiCallBack> UpdateAsync(CoreCmsAgentOrder entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<AdminUiCallBack> UpdateAsync(List<CoreCmsAgentOrder> entity);
