...
namespace Yichen.Comm.Repository
{
    public abstract class BaseRepository<T> : IBaseRepository<T> where T : class, new()
    {
        ...
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        /// <returns></returns>
        public DataTable QueryDT(bool blUseNoLock = false)
        {
            return blUseNoLock
                ? DbBaseClient.Queryable<T>().With(SqlWith.NoLock).ToDataTable()
                : DbBaseClient.Queryable<T>().ToDataTable();
        }
        ...
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        /// <returns></returns>
        public async Task<DataTable> QueryDTAsync(bool blUseNoLock = false)
        {
            return blUseNoLock
                ? await DbBaseClient.Queryable<T>().With(SqlWith.NoLock).ToDataTableAsync()
                : await DbBaseClient.Queryable<T>().ToDataTableAsync();
        }
        ...
        public List<T> QueryListByClause(string strWhere, string orderBy, bool blUseNoLock)
        {
            return blUseNoLock
        ...
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        /// <returns>泛型实体集合</returns>
        public DataTable QueryDTByClause(string strWhere, string orderBy, bool blUseNoLock)
        {
            return blUseNoLock
                ? DbBaseClient.Queryable<T>().OrderByIF(!string.IsNullOrEmpty(orderBy), orderBy)
                    .WhereIF(!string.IsNullOrEmpty(strWhere), strWhere).With(SqlWith.NoLock).ToDataTable()
                : DbBaseClient.Queryable<T>().OrderByIF(!string.IsNullOrEmpty(orderBy), orderBy)
                    .WhereIF(!string.IsNullOrEmpty(strWhere), strWhere).ToDataTable();
        }
        ...
        /// <returns>泛型实体集合</returns>
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        public async Task<DataTable> QueryDTByClauseAsync(string strWhere, string orderBy = "",
            bool blUseNoLock = false)
        {
            return blUseNoLock
                ? await DbBaseClient.Queryable<T>().OrderByIF(!string.IsNullOrEmpty(orderBy), orderBy)
                    .WhereIF(!string.IsNullOrEmpty(strWhere), strWhere).With(SqlWith.NoLock).ToDataTableAsync()
                : await DbBaseClient.Queryable<T>().OrderByIF(!string.IsNullOrEmpty(orderBy), orderBy)
                    .WhereIF(!string.IsNullOrEmpty(strWhere), strWhere).ToDataTableAsync();
        }
        ...
        /// <returns>泛型实体集合</returns>
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        public List<T> QueryListByClause(Expression<Func<T, bool>> predicate,bool blUseNoLock)
        {
            return blUseNoLock
        ...
        /// <returns>泛型实体集合</returns>
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        public DataTable QueryDTByClause(Expression<Func<T, bool>> predicate,bool blUseNoLock)
        {
            return blUseNoLock
                ? DbBaseClient.Queryable<T>()
                    .WhereIF(predicate != null, predicate).With(SqlWith.NoLock).ToDataTable()
                : DbBaseClient.Queryable<T>()
                    .WhereIF(predicate != null, predicate).ToDataTable();
        }
        ...
        /// <returns>泛型实体集合</returns>
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        public DataTable QueryDTByClause(Expression<Func<T, bool>> predicate, string orderBy,bool blUseNoLock)
        {
            return blUseNoLock
                ? DbBaseClient.Queryable<T>().OrderByIF(!string.IsNullOrEmpty(orderBy), orderBy)
                    .WhereIF(predicate != null, predicate).With(SqlWith.NoLock).ToDataTable()
        ...
        /// <returns>泛型实体集合</returns>
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        public async Task<DataTable> QueryDTByClauseAsync(Expression<Func<T, bool>> predicate)
        {
            return await DbBaseClient.Queryable<T>()
                    .WhereIF(predicate != null, predicate).ToDataTableAsync();
        }
        ...
        /// <returns>泛型实体集合</returns>
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        public async Task<List<T>> QueryListByClauseAsync(Expression<Func<T, bool>> predicate,bool blUseNoLock)
        {
            return blUseNoLock
        ...
        /// <returns>泛型实体集合</returns>
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        public async Task<DataTable> QueryDTByClauseAsync(Expression<Func<T, bool>> predicate,bool blUseNoLock)
        {
            return blUseNoLock
                ? await DbBaseClient.Queryable<T>()
                    .WhereIF(predicate != null, predicate).With(SqlWith.NoLock).ToDataTableAsync()
                : await DbBaseClient.Queryable<T>()
                    .WhereIF(predicate != null, predicate).ToDataTableAsync();
        }
        ...
        /// <returns>泛型实体集合</returns>
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        public async Task<DataTable> QueryDTByClauseAsync(Expression<Func<T, bool>> predicate, string orderBy,
            bool blUseNoLock)
        {
            return blUseNoLock
                ? await DbBaseClient.Queryable<T>().OrderByIF(!string.IsNullOrEmpty(orderBy), orderBy)
        ...
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        /// <returns>泛型实体集合</returns>
        public DataTable QueryDTByClause(Expression<Func<T, bool>> predicate,
            Expression<Func<T, object>> orderByPredicate, OrderByType orderByType, bool blUseNoLock = false)
        {
            return blUseNoLock
                ? DbBaseClient.Queryable<T>().OrderByIF(orderByPredicate != null, orderByPredicate, orderByType)
        ...
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        /// <returns></returns>
        public DataTable QueryDTByClause(Expression<Func<T, bool>> predicate, int take,
            Expression<Func<T, object>> orderByPredicate, OrderByType orderByType, bool blUseNoLock = false)
        {
            return blUseNoLock
                ? DbBaseClient.Queryable<T>().OrderByIF(orderByPredicate != null, orderByPredicate, orderByType)
                    .WhereIF(predicate != null, predicate).Take(take).With(SqlWith.NoLock).ToDataTable()
                : DbBaseClient.Queryable<T>().OrderByIF(orderByPredicate != null, orderByPredicate, orderByType)
                    .WhereIF(predicate != null, predicate).Take(take).ToDataTable();
        }
        ...
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        /// <returns></returns>
        public async Task<DataTable> QueryDTByClauseAsync(Expression<Func<T, bool>> predicate, int take,
            Expression<Func<T, object>> orderByPredicate, OrderByType orderByType, bool blUseNoLock = false)
        {
            return blUseNoLock
                ? await DbBaseClient.Queryable<T>().OrderByIF(orderByPredicate != null, orderByPredicate, orderByType)
                    .WhereIF(predicate != null, predicate).Take(take).With(SqlWith.NoLock).ToDataTableAsync()
                : await DbBaseClient.Queryable<T>().OrderByIF(orderByPredicate != null, orderByPredicate, orderByType)
                    .WhereIF(predicate != null, predicate).Take(take).ToDataTableAsync();
        }
        ...
        /// <param name="blUseNoLock">是否使用WITH(NOLOCK)</param>
        /// <returns></returns>
        public DataTable QueryDTByClause(Expression<Func<T, bool>> predicate, int take, string strOrderByFileds = "",
            bool blUseNoLock = false)
        {
            return blUseNoLock
                ? DbBaseClient.Queryable<T>().OrderByIF(!string.IsNullOrEmpty(strOrderByFileds), strOrderByFileds)
                    .Where(predicate).Take(take).With(SqlWith.NoLock).ToDataTable()
                : DbBaseClient.Queryable<T>().OrderByIF(!string.IsNullOrEmpty(strOrderByFileds), strOrderByFileds)
                    .Where(predicate).Take(take).ToDataTable();
        }
            ...
            string strOrderByFileds = "", bool blUseNoLock = false)
        {
            return blUseNoLock
                ? await DbBaseClient.Queryable<T>().OrderByIF(!string.IsNullOrEmpty(strOrderByFileds), strOrderByFileds)
                    .Where(predicate).Take(take).With(SqlWith.NoLock).ToDataTableAsync()
                : await DbBaseClient.Queryable<T>().OrderByIF(!string.IsNullOrEmpty(strOrderByFileds), strOrderByFileds)
                    .Where(predicate).Take(take).ToDataTableAsync();
        }
        ...
        public async Task<bool> InsertAsync(string strSql, SugarParameter[] parameters = null)
        ...
        /// <param name="entity">实体类</param>
        /// <returns></returns>
        public async Task<bool> HideAsync(object id)
        {
            return await DbBaseClient.Updateable<T>().SetColumns("dstate",true).Where("id="+id).ExecuteCommandHasChangeAsync(); ;
        }
        ...
        ///// <param name="sql"></param>
        ///// <returns></returns>
        //public async Task<List<T>> SqlQueryableDT(string sql)
        //{
        //    var list = await DbBaseClient.SqlQueryable<T>(sql).ToListAsync(); ;
        //    return list;
        //}
