...
namespace Yichen.Net.IRepository
{
    ...
    public interface ICoreCmsUserServicesOrderRepository : IBaseRepository<CoreCmsUserServicesOrder>
    {
        ...
        ///// <returns></returns>
        //Task<AdminUiCallBack> InsertAsync(CoreCmsUserServicesOrder entity);
        ...
        ///// <param name="entity"></param>
        ///// <returns></returns>
        //Task<AdminUiCallBack> UpdateAsync(CoreCmsUserServicesOrder entity);
        ...
        ///// <param name="entity"></param>
        ///// <returns></returns>
        //Task<AdminUiCallBack> UpdateAsync(List<CoreCmsUserServicesOrder> entity);
