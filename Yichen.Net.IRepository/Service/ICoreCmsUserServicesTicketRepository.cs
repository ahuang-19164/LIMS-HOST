...
namespace Yichen.Net.IRepository
{
    ...
    public interface ICoreCmsUserServicesTicketRepository : IBaseRepository<CoreCmsUserServicesTicket>
    {
        ...
        ///// <returns></returns>
        //Task<AdminUiCallBack> InsertAsync(CoreCmsUserServicesTicket entity);
        ...
        ///// <param name="entity"></param>
        ///// <returns></returns>
        //Task<AdminUiCallBack> UpdateAsync(CoreCmsUserServicesTicket entity);
        ...
        ///// <param name="entity"></param>
        ///// <returns></returns>
        //Task<AdminUiCallBack> UpdateAsync(List<CoreCmsUserServicesTicket> entity);
