...
namespace Yichen.Net.IRepository
{
    ...
    public interface ISysNLogRecordsRepository : IBaseRepository<SysNLogRecords>
    {
        ...
        ///// <returns></returns>
        //Task<AdminUiCallBack> InsertAsync(SysNLogRecords entity);
        ...
        ///// <param name="entity"></param>
        ///// <returns></returns>
        //Task<AdminUiCallBack> UpdateAsync(SysNLogRecords entity);
        ...
        ///// <param name="entity"></param>
        ///// <returns></returns>
        //Task<AdminUiCallBack> UpdateAsync(List<SysNLogRecords> entity);
