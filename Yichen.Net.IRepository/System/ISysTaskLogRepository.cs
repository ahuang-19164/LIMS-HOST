...
namespace Yichen.Net.IRepository
{
    ...
    public interface ISysTaskLogRepository : IBaseRepository<SysTaskLog>
    {
        ...
        ///// <returns></returns>
        //Task<AdminUiCallBack> InsertAsync(SysTaskLog entity);
        ...
        ///// <param name="entity"></param>
        ///// <returns></returns>
        //Task<AdminUiCallBack> UpdateAsync(SysTaskLog entity);
        ...
        ///// <param name="entity"></param>
        ///// <returns></returns>
        //Task<AdminUiCallBack> UpdateAsync(List<SysTaskLog> entity);
