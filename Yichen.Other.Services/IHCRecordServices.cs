...
namespace Yichen.Other.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class IHCRecordServices : BaseServices<IHCRecord>, IIHCRecordServices
    {
        private readonly IIHCRecordRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public IHCRecordServices(IUnitOfWork unitOfWork, IIHCRecordRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
