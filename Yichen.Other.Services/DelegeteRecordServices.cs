...
namespace Yichen.Other.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class DelegeteRecordServices : BaseServices<DelegeteRecord>, IDelegeteRecordServices
    {
        private readonly IDelegeteRecordRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public DelegeteRecordServices(IUnitOfWork unitOfWork, IDelegeteRecordRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
