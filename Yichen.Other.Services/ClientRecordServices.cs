...
namespace Yichen.Other.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class ClientRecordServices : BaseServices<ClientRecord>, IClientRecordServices
    {
        private readonly IClientRecordRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public ClientRecordServices(IUnitOfWork unitOfWork, IClientRecordRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
