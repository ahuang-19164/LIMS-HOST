...
namespace Yichen.Other.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class CrisisRecordServices : BaseServices<other_crisisrecord>, ICrisisRecordServices
    {
        private readonly ICrisisRecordRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public CrisisRecordServices(IUnitOfWork unitOfWork, ICrisisRecordRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
