...
namespace Yichen.System.IServices
{
    ...
    ///  服务工厂接口
    /// </summary>
    public interface ICompanyInfoServices : IBaseServices<CompanyInfo>
    {
        #region 重写增删改查操作===========================================================
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<WebApiCallBack> InsertAsync(CompanyInfo entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<WebApiCallBack> UpdateAsync(CompanyInfo entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<WebApiCallBack> UpdateAsync(List<CompanyInfo> entity);
        ...
        /// </summary>
        /// <returns></returns>
        Task<List<CompanyInfo>> GetCaChe();

        /// <summary>
        ///     更新cache
        /// </summary>
        Task<List<CompanyInfo>> UpdateCaChe();
        ...
        /// <returns></returns>
        Task<IPageList<CompanyInfo>> QueryPageAsync(
