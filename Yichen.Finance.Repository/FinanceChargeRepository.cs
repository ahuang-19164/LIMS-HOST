...
namespace Yichen.Finance.Repository
{
    ...
    /// 用户课程范围 接口实现
    /// </summary>
    public class FinanceChargeRepository : BaseRepository<finance_group_charge>, IFinanceChargeRepository
    {
        private readonly IUnitOfWork _unitOfWork;
        public FinanceChargeRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        ...
        /// <returns></returns>
        public  async new Task<AdminUiCallBack> InsertAsync(finance_group_charge entity)
        {
        ...
        /// <returns></returns>
        public  async new Task<AdminUiCallBack> UpdateAsync(finance_group_charge entity)
        {
            var jm = new AdminUiCallBack();
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public  async new Task<AdminUiCallBack> UpdateAsync(List<finance_group_charge> entity)
        {
            var jm = new AdminUiCallBack();
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public  async new Task<AdminUiCallBack> DeleteByIdAsync(object id)
        {
            var jm = new AdminUiCallBack();
        ...
        /// <returns></returns>
        public  async new Task<AdminUiCallBack> DeleteByIdsAsync(int[] ids)
        {
            var jm = new AdminUiCallBack();
