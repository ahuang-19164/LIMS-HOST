...
namespace Yichen.Net.Utility.Helper
{
    /// <summary>
    /// 通用帮助类
    /// </summary>
    public static class CommonHelper
    {
        ...
        /// </summary>
        /// <param name="password">要加密的字符串</param>
        /// <param name="consts">常量</param>
        /// <returns></returns>
        public static string EnPassword(string password, string consts)
        {
            //var dtStr = createTime.ToString("yyyyMMddHHmmss");
            var md5 = Md5For32(password);
            var enPwd = Md5For32(md5 + consts);
            return enPwd;
        }
        #endregion
