 ...
 *          NameSpace: Yichen.Net.Framework.Utility.Extensions
...
namespace Yichen.Net.Utility.Extensions
{
    /// <summary>
    /// 扩展数据转换
    /// </summary>
    public static class ObjectExtensions
    {
        ...
        {
            double result = -9999;
            return thisValue != null && thisValue != DBNull.Value && double.TryParse(thisValue.ToString(), out result) ? result : -9999;
        }
