...
namespace Yichen.Finance.IServices
{
    ...
    ///  服务工厂接口
    /// </summary>
    public interface IFundInfoServices : IBaseServices<FundInfo>
    {
        #region 重写增删改查操作===========================================================
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        new Task<WebApiCallBack> InsertAsync(FundInfo entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        new Task<WebApiCallBack> UpdateAsync(FundInfo entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        new Task<WebApiCallBack> UpdateAsync(List<FundInfo> entity);
        ...
        ///// </summary>
        ///// <returns></returns>
        //new Task<List<FundInfo>> GetCaChe();

        ///// <summary>
        /////     更新cache
        ///// </summary>
        //new Task<List<FundInfo>> UpdateCaChe();
        ...
        /// <returns></returns>
        new Task<IPageList<FundInfo>> QueryPageAsync(
