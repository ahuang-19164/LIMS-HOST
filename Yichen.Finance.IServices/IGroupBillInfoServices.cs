...
namespace Yichen.Finance.IServices
{
    ...
    ///  服务工厂接口
    /// </summary>
    public interface IGroupBillInfoServices : IBaseServices<GroupBillInfo>
    {
        #region 重写增删改查操作===========================================================
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        new Task<WebApiCallBack> InsertAsync(GroupBillInfo entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        new Task<WebApiCallBack> UpdateAsync(GroupBillInfo entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        new Task<WebApiCallBack> UpdateAsync(List<GroupBillInfo> entity);
        ...
        ///// </summary>
        ///// <returns></returns>
        //new Task<List<GroupBillInfo>> GetCaChe();

        ///// <summary>
        /////     更新cache
        ///// </summary>
        //new Task<List<GroupBillInfo>> UpdateCaChe();
        ...
        /// <returns></returns>
        new Task<IPageList<GroupBillInfo>> QueryPageAsync(
